...
public class update_bronze extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_bronze);
        ...
        if (actionBar != null) {
            actionBar.setTitle("Bronze Package");
        }
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(update_bronze.this, last_platinum.class);
