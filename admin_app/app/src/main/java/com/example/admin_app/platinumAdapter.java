...
public class platinumAdapter extends BaseAdapter {

    private final ArrayList<hotelData> dataList;
    private final Context context;
    LayoutInflater layoutInflater;

    public platinumAdapter(ArrayList<hotelData> dataList, Context context) {
