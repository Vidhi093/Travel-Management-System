...
public class hotelbittadapter extends BaseAdapter {

        private final ArrayList<hotelBillData> dataList;
        private final Context context;
        LayoutInflater layoutInflater;

    public hotelbittadapter(ArrayList<hotelBillData> dataList, Context context) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            gridtextview.setText(dataList.get(position).getHotel_name());
            return convertView;
        }
