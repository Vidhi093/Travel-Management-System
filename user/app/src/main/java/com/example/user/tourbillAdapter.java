...
public class tourbillAdapter extends BaseAdapter {

        private final ArrayList<tourbillData> dataList;
        private final Context context;
        LayoutInflater layoutInflater;

    public tourbillAdapter(ArrayList<tourbillData> dataList, Context context) {
